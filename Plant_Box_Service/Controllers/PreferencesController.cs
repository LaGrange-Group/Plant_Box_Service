...
namespace Plant_Box_Service.Controllers
{
    public class PreferencesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,IsLarge,OptimalSize,FlexibleSize,DrapeClimb,Cacti,Hanging,FoodBearing,Bonsai,Tillandsia,Flowers,PerishablesOnly")] Preference preference)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,IsLarge,OptimalSize,FlexibleSize,DrapeClimb,Cacti,Hanging,FoodBearing,Bonsai,Tillandsia,Flowers,PerishablesOnly")] Preference preference)
        {
            if (ModelState.IsValid)
            {
